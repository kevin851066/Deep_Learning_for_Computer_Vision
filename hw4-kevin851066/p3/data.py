...
#     l = sorted(os.listdir("../hw4_data/FullLengthVideos/videos/train"))
#     print(l)
    # for i in range(len(l)):
    #     categ_length = len(os.listdir(os.path.join("../hw4_data/FullLengthVideos/videos/train", l[i])))
    #     print("cate: ", categ_length)
    #     scale = math.floor(categ_length/256)
    #     print("scale: ", scale)
    #     num = round(categ_length / scale)
    #     print("num: ", num)

    # file_list = sorted(os.listdir(os.path.join("../hw4_data/FullLengthVideos/videos/train", l[0])))
    # print(len(file_list))

    # f = open('../hw4_data/FullLengthVideos/labels/train/OP01-R01-PastaSalad.txt', 'r')
    # label_list = f.read().split('\n')
